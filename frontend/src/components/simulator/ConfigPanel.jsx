          ...
          <div>
            ...
            <div className="bg-slate-50 rounded-lg p-3 space-y-2 text-xs">
              ...
              {component.performance.maxReadQPS && (
                <div className="flex justify-between">
                  <span className="text-slate-500">Max Read QPS:</span>
                  <span className="font-medium text-slate-900">
                    {component.performance.maxReadQPS.toLocaleString()}
                  </span>
                </div>
              )}
              {component.performance.avgReadLatency && (
                <div className="flex justify-between">
                  <span className="text-slate-500">Avg Latency:</span>
                  <span className="font-medium text-slate-900">
                    {component.performance.avgReadLatency}ms
                  </span>
                </div>
              )}
              <div className="flex justify-between">
