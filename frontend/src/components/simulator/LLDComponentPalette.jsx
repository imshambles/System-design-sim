...
const LLDComponentPalette = () => {
  ...
  return (
    <div className={`bg-white border-r border-slate-200 overflow-y-auto transition-all duration-300 ${
      ...
      <div className="p-4 border-b border-slate-200 flex items-center justify-between">
        {!isCollapsed ? (
          ...
          <div className="flex-1 flex justify-center">
            <span className="font-bold text-slate-900 transform -rotate-90 whitespace-nowrap origin-center translate-y-12">
              LLD Components
            </span>
          </div>
        )}
